...
$string["allowcontinueattempts_details"] =
    "If enabled, students can resume a previous incomplete attempt from where they left off.";
$string["allowcontinueattempts_help"] =
    "If enabled, students can resume a previous incomplete attempt from where they left off.";
$string[
    "attemptreusequestion"
] = "Do you want to continue your previous attempt (yes) ?<br>
...
$string[
    "modulename_help"
] = 'Poodll MiniLesson combines several language learning activities into a simple, self-guided online lesson.
...
$string["maxattempts_details"] =
    "Maximum number of attempts allowed in this activity.";
...
$string["welcomelabel_details"] =
    "The default text to show in the welcome field when creating a new Mini Lesson activity.";
...
$string["incompleteattemptsreport_explanation"] =
    "A list of incomplete attempts";
...
$string["deleteattemptconfirm"] =
    "Are you sure that you want to delete this attempt?";
$string["deletenow"] = "";
$string["itemsperpage"] = "Items per page";
$string["itemsperpage_details"] =
    "This sets the number of rows to be shown on reports or lists of attempts.";
...
$string["apiuser_details"] =
    "The Poodll account username that authorises Poodll on this site.";
...
$string["azureapikey_details"] =
    'The Azure API key. This will use your Azure account for speech services with Minilesson. It is optional This is primarily for use by our users in Mainland China (Ningxia region). See <a href= "https://learn.microsoft.com/en-us/azure/cognitive-services/speech-service/overview">here</a> for more details.';
$string["azureapiregion"] = "Azure Region";
$string["azureapiregion_details"] =
    "The Azure region for which the Azure API key was generated.";
...
$string["region_details"] =
    "The AWS Region sets where data is stored and processed.";
...
$string["noapiuser"] =
    "No API user entered. MiniLesson will not work correctly.";
$string["noapisecret"] =
    "No API secret entered. MiniLesson will not work correctly.";
$string["credentialsinvalid"] =
    "The API user and secret entered could not be used to get access. Please check them.";
$string["appauthorised"] = "Poodll MiniLesson is authorised for this site.";
$string["appnotauthorised"] =
    "Poodll MiniLesson is NOT authorised for this site.";
$string["refreshtoken"] = "Refresh license information";
$string["notokenincache"] =
    "Refresh to see license information. Contact Poodll support if there is a problem.";
// these errors are displayed on activity page
$string["nocredentials"] =
    'API user and secret not entered. Please enter them on <a href="{$a}">the settings page.</a> You can get them from <a href="https://poodll.com/member">Poodll.com.</a>';
$string["novalidcredentials"] =
    'API user and secret were rejected and could not gain access. Please check them on <a href="{$a}">the settings page.</a> You can get them from <a href="https://poodll.com/member">Poodll.com.</a>';
$string["nosubscriptions"] =
    "There is no current subscription for this site/plugin.";

$string["privacy:metadata:attemptid"] =
    "The unique identifier of a users MiniLesson attempt.";
$string["privacy:metadata:minilessonid"] =
    "The unique identifier of a MiniLesson activity instance.";
...
$string["privacy:metadata:sessiontime"] =
    "The session time(recording time) for the attempt";
...
$string["privacy:metadata:timemodified"] =
    "The last time attempt was modified for the attempt";
$string["privacy:metadata:attempttable"] =
    "Stores the scores and other user data associated with a MiniLesson attempt.";
$string["privacy:metadata:transcriptpurpose"] =
    "The recording short transcripts.";
$string["privacy:metadata:fulltranscriptpurpose"] =
    "The full transcripts of recordings.";
$string["privacy:metadata:cloudpoodllcom:userid"] =
    "The MiniLesson plugin includes the moodle userid in the urls of recordings and transcripts";
$string["privacy:metadata:cloudpoodllcom"] =
    "The MiniLesson plugin stores recordings in AWS S3 buckets via cloud.poodll.com.";
$string["privacy:metadata"] =
    "The Poodll MiniLesson plugin does store personal data.";
$string["privacy:metadata:moduleid"] =
    "The unique identifier of a MiniLesson activity instance.";
$string["privacy:metadata:errorcount"] =
    "The error count of a users MiniLesson attempt.";
...
$string["confirmitemdelete"] =
    'Are you sure you want to <i>DELETE</i> item? : {$a}';
$string["confirmitemdeletetitle"] = "Really Delete item?";
$string["confirmattemptdeletetitle"] = "Really Delete Attempt?";
$string["confirmattemptdelete"] =
    "Are you sure you want to <i>DELETE</i> this attempt?";
$string["confirmattemptdeletealltitle"] = "Really Delete ALL Attempts?";
$string["confirmattemptdeleteall"] =
    "Are you sure you want to <i>DELETE ALL</i> attempts?";
...
$string["dictation_instructions1"] =
    "Listen and type each sentence that you hear.";
...
$string["spacegame_instructions1"] =
    "Shoot the aliens by selecting the correct answer.";
$string["freespeaking_instructions1"] =
    "Use the microphone to record your answer to the question.";
$string["passagereading_instructions1"] =
    "Use the microphone to record yourself reading the passage.";
$string["freewriting_instructions1"] =
    "Type your answer to the question in the text area below.";
$string["enablevkeyboard"] = "Enable Virtual Keyboard";
$string["fluency_instructions1"] =
    "Read the sentences aloud. Click the microphone icon to start recording.";
$string["conversation_instructions1"] = "replace these instructions.";
$string["audiochat_instructions1"] =
    "Practice speaking with your AI partner about the topic.";
$string["wordshuffle_instructions1"] =
    "Put the words in the correct order to form a sentence.";
$string["scatter_instructions1"] = "Choose the word pairs";
$string["slides_instructions1"] =
    "Click > or < to go forward or backward through the slides.";
$string["fiction_instructions1"] =
    "Follow the instructions and make good choices. Good luck.";
...
$string["attemptresultsheading"] =
    '{$a->username}: Attempt({$a->attemptid}): Score: {$a->sessionscore}% : - {$a->date} ';
...
$string["enterresponses"] =
    "Enter a list of correct responses, and an optional list of partially correct responses, in the text areas below.";
...
$string["phraseresponses"] =
    "Enter a list of items in the text area below. Each item should be a on a new line. The format is:<br> audio prompt | correct response (optional)| text prompt (optional) <br>e.g How are you?|I am fine.";
$string["fluencyresponses"] =
    "Enter a list of phrases/sentences in the text area below. Each item should be a on a new line. Optionally add a translation or hint to be shown to student for each sentence, using the format: sentence | <i>hint</i> <br>e.g Hello|<i>Hola</i>";
...
$string["prompttype_help"] =
    "Use plain text and separate selectors for adding media files, or a rich text editor";
...
$string["reattemptbody"] =
    "If you continue your previous attempt will be replaced with this one. OK?";

// media toggles
$string["addmedia"] = "Image / audio or video";
$string["addmedia_instructions"] =
    "Choose the media type you want to show in the lesson item.";
$string["addiframe"] = "iFrame / custom HTML";
$string["addiframe_instructions"] =
    "Paste the embed code for the iframe you want to show in the lesson item.";
$string["addttsaudio"] = "TTS Audio";
$string["addttsaudio_instructions"] =
    "Enter the text you want to be spoken by the TTS engine.";
$string["addtextarea"] = "Text Block";
$string["addtextarea_instructions"] =
    "Enter the text you want to show in the lesson item.";
$string["addyoutubeclip"] = "YouTube Clip";
$string["addyoutubeclip_instructions"] =
    "Enter the Youtube/Vimeo video ID and start and end times for the clip you want to show in the lesson item.";
$string["addttsdialog"] = "TTS Dialog";
$string["addttsdialog_instructions"] = "Add TTS Dialog";
$string["addttspassage"] = "TTS Passage";
$string["ttspassageinstructions"] =
    "Choose the speaker voice and speed, and enter the passage to be read.";
$string["addttspassage_instructions"] =
    "Choose the speaker voice and speed, and enter the passage to be read.";
$string["addaudiostory"] = "Audio Story";
$string["addaudiostory_instructions"] =
    "To create an audio story, add an audio file, image files with numerical names (eg 1.png,2.jpg) and an optional subtitle track (.vtt file). Set image entry times (format HH:MM:SS) in the text area. If no audio file is present, and a TTS Audio media prompt has been set, the audio story will use that.";
$string["nativelangchooser"] = "Native Language Chooser";
$string["nativelangchooser_instructions"] =
    "Allow users to choose their native language from a dropdown list.";
...
$string["enablesetuptab_details"] =
    "Don't check this. It will show a tab containing the activity instance settings to admins. This is for a special use case and minilesson pages will show without headers,footers or blocks.";
$string["setup"] = "Setup";
...
$string["reportsmenutoptext"] =
    "Review grade and attempts details using the report buttons below.";
...
$string["freetrial_desc"] =
    "A dialog should appear that allows you to register for a free trial with Poodll. After registering you should login to the members dashboard to get your API user and secret. And to register your site URL.";
// $string['memberdashboard'] = "Member Dashboard";
// $string['memberdashboard_desc'] = "";
$string["fillcredentials"] =
    "Set API user and secret with existing credentials";

$string["viewstart"] = "Activity open";
$string["viewend"] = "Activity close";
$string["viewstart_help"] =
    "If set, prevents a student from entering the activity before the start date/time.";
$string["viewend_help"] =
    "If set, prevents a student from entering the activity after the closing date/time.";
...
$string["ttsdialogvisible_desc"] =
    "Uncheck if the students should not see the dialog text.";
...
$string["ttsdialoginstructions"] =
    "Choose the speaker voices for roles A,B and C and enter the dialog. Begin each dialog line with the speaker role + ')'. e.g A) Hello. Sound effect lines begin with >> e.g >>seagulls";
...
$string["courseattemptsreport_explanation"] =
    "All minilesson attempts in the course";
...
$string["reportstable_details"] =
    "Ajax tables are faster to use and can sort data. Paged tables load faster but are harder to navigate with.";
...
$string["animations_details"] =
    "Transitions between item subtypes are animated. If fancy animation causes trouble, choose plain.";
...
$string["containerwidth_details"] =
    "Sets the max-width of the minilesson activity container in view mode.";
$string["containerwidth_help"] =
    "Sets the max-width of the minilesson activity container in view mode.";
...
$string["lessonfont_details"] =
    "A font name that will override site default for this minilesson when displayed. Must be exact in spelling and case. eg Andika or Comic Sans MS";
$string["lessonfont_help"] =
    "A font name that will override site default for this minilesson when displayed. Must be exact in spelling and case. eg Andika or Comic Sans MS";
$string["advanced"] = "Advanced";
$string["multiaudio_instructions1"] =
    "Choose the correct answer. Use the mic to read it aloud.";
...
$string["sg_instructions1"] =
    "Use the microphone and say the full sentence including the missing words";
...
$string["modaleditform_details"] =
    "Adding or editing items in the Minilesson can be done via a modal(popup) form or on a new page";
$string["modaleditform_newpage"] = "New page";
$string["modaleditform_modalform"] = "Modal form (popup)";
$string["timelimit"] = "Time limit";
$string["gapfillitemsdesc"] =
    "Enter the list of items in the text area below. Each item should be on a new line. The letter gaps should be enclosed in square brackets: [ ].The format is:<br>Text prompt | hint<br>.e.g  This is my d[og]| a common pet";
$string["listeninggapfillitemsdesc"] =
    "Enter the list of items in the text area below. Each item should be on a new line. The letter gaps should be enclosed in square brackets: [ ]. The format is:<br>Text prompt<br>.e.g  This is my d[og]";
$string["readsentences"] = "Read Sentences (TTS)";
$string["readsentences_desc"] =
    "If checked each sentence will be read aloud. It will be a form of dictation";
$string["allowretry"] = "Allow retry";
$string["allowretry_desc"] =
    "If checked allows students to submit new attempts, if their previous response was not correct.";
$string["audiochatretry_desc"] =
    "If checked students can re-start the chat session again immediately after they finish.";
...
$string["examplecsv_help"] =
    "To use the example csv file, download it then open it with a text or spreadsheet editor. Leave the first line unchanged, then edit the following lines (records) and add your Minilesson item data, adding more lines as necessary. Save the file as CSV then upload it.";
$string["examplejson"] = "Example json file";
$string["examplejson_help"] =
    'To use the example json file, download it then open it with a text or spreadsheet editor. Edit and re-use items in the items array where they match the item type you need, and remove items you don\'t need. Save the file as JSON then upload.';
$string["importdotranslate"] = "Translate items during import";
$string["importdotranslate_help"] =
    "When enabled, JSON items are translated from the selected source language to the chosen target language before being imported.";
...
$string["bulkdeletequestion"] =
    "Are you sure you want to delete the selected question?";

$string["speechtester_recordinstructions"] =
    "Record audio here to be used in testing. You can optionally choose to upload audio by pressing the upload audio button.";
$string["modelaudio_playerinstructions"] =
    "The current audio can be played using the player below.";
...
$string["deletefilesfirst"] =
    "Delete any files you added manually. They will not be deleted automatically.";
$string["cleartextfirst"] =
    "Clear any content you added manually. It will not be deleted automatically.";

$string["itemsettingsheadings"] = "Item Settings";

$string["finishscreen"] = "Finish Screen";
$string["finishscreen_details"] =
    "When you finish the activity, you can see a simple screen, a full screen or a custom screen. The custom screen is a page you can design yourself.";
$string["finishscreen_help"] =
    "When you finish the activity, you can see a simple screen, a full screen or a custom screen. The custom screen is a page you can design yourself.";
...
$string["finishscreencustom_help"] =
    "The custom screen is an advanced feature, that allows you to build a custom finish screen using mustache notation and variables. Some of the variables are: {total} {courseurl} {coursename} {yellowstars} {graystars} {reattempturl} and an array of {results} each with {title}, {grade}, {yellowstars} and {graystars} variables.";
$string["finishscreencustom_details"] =
    "If the activity finish screen options are set to 'custom' this will be the default mustache template that generates the finish screen. It can be overridden at the activity level.";
$string["freewritingdesc"] =
    "Set target word count and grading and feedback guidelines for the AI evaluation. Students should type their answer to the topic, and they will receive an AI powered grade and feedback.";
$string["freespeakingdesc"] =
    "Set target word count and grading and feedback guidelines for the AI evaluation. Students should record themselves speaking on the topic, and they will receive an AI powered grade and feedback.";
$string["conversationdesc"] = "[conversation desc. here]";
$string["audiochatdesc"] =
    "Set a discussion topic or question and instructions and a role for the AI";
$string["fluencydesc"] = "[fluency desc. here]";
$string["spacegamedesc"] = "[space game desc. here]";
$string["passagereadingdesc"] =
    "Enter a passage to read in the text area below. The student should read the passage aloud.";
$string["passagegapfilldesc"] =
    "Enter a passage of text in the text area below. The word gaps should be enclosed in square brackets: [ ]. A short passage might look like this:  This is my [dog] and my [cat].";
...
$string["emptyquiz"] =
    "There are no multiple choice questions in the selected category.";
$string["endofgame"] = 'Your score was: {$a}. Press space or click to restart.';
$string["fullscreen"] = "Fullscreen";
$string["howtoplay"] = "How to play";
$string[
    "howtoplay_help"
] = 'You can move the ship by using the arrow keys, or by dragging it with the mouse.
...
$string["playedxtimeswithhighscore"] =
    'Played {$a->times} times. The last game ended with a high score of {$a->score}';
...
$string["includematching_desc"] =
    'Include \'Shoot the Pairs\' matching game in the Space Game';
...
$string["enterspacegameitems"] =
    "Enter the list of items in the text area below. Each item should be on a new line. The format is:<br>Question | Answer<br>e.g What is the capital of France?|Paris";
$string["showdetailedresults"] = "Show detailed results";
$string["hidestartpage"] = "Hide start page";
$string["hidestartpage_desc"] =
    "If checked the activity item begins as soon as it has loaded.";
$string["aigrade_modelanswer"] = "Model answer";
$string["relevancetype"] = "Relevance type";
$string["relevancetype_desc"] =
    "AI can penalize answers of low relevance. Choose the type of relevance to use.";
$string["relevancetype_help"] =
    "AI can penalize answers of low relevance. Choose the type of relevance to use. If you choose relevance to the question, the AI will check if the answer is on topic. If you choose relevance to a model answer, the AI will check if the answer is similar in content to the model answer you provide.";
$string["aigrade_instructions"] = "Grading Instructions for AI";
$string["aigrade_instructions_desc"] =
    'The instructions tell AI how to generate a "score" between 0 and the total marks for this item. They are a template that will be merged with the AI topic, AI data 1, AI data 2 to create the instructions. You can use the following variables in the instructions: {topic}, {ai data1}, {ai data2}. The resulting AI grade will be multiplied by the total words spoken over the target word count, so that answers that are too brief are penalized. Set target word count to 0 if that is not desireable.';
$string["aigrade_instructions_help"] =
    'The instructions tell AI how to generate a "score" between 0 and the total marks for this item. They are a template that will be merged with the AI topic, AI data 1, AI data 2 to create the instructions. You can use the following variables in the instructions: {topic}, {ai data1}, {ai data2}. The resulting AI grade will be multiplied by the total words spoken over the target word count, so that answers that are too brief are penalized. Set target word count to 0 if that is not desireable.';
$string["aigrade_feedback"] = "Feedback Instructions for AI";
$string["aigrade_feedback_desc"] =
    "The feedback instructions tell AI how to give feedback to the student on their response. They are a template that will be merged with the AI topic, AI data 1, AI data 2 to create the instructions. You can use the following variables in the instructions: {topic}, {ai data1}, {ai data2}.";
$string["aigrade_feedback_help"] =
    "The feedback instructions tell AI how to give feedback to the student on their response. They are a template that will be merged with the AI topic, AI data 1, AI data 2 to create the instructions. You can use the following variables in the instructions: {topic}, {ai data1}, {ai data2}.";
$string["aigrade_feedback_language"] = "AI Feedback Language";
$string["aigrade_instructions_preset"] =
    "Select a preset from the list to load ready made instructions into the text area below. You can modify the instructions as you wish.";
...
$string["totalmarks_instructions"] =
    "The total marks this item contributes to the MiniLesson activity score.";
$string["reallyreattempt"] =
    "Your previous attempt will be overwritten. Are you sure you want to try again?";
$string["pr_totalmarks_instructions"] =
    "The total marks this passage reading contributes to the MiniLesson activity score. Leave as 0 and total marks will equal the passage word count. A score will be calculated from the percentage read correctly otherwise.";
$string["alternates"] = "Alternates";
$string["pr_alternates_instructions"] =
    'Alternates allows the activity author to specify acceptable mistranscriptions for specific passage words. 1 word set per line. e.g their|there|they\'re See <a href="https://support.poodll.com/support/solutions/articles/19000096937-tuning-your-read-aloud-activity">docs</a> for more details.';
...
$string["showitemreview_help"] =
    "Immediately after the student has attempted the item, show them the correct answer and any feedback, if the item supports it.";
$string["showitemreview_details"] =
    "Immediately after the student has attempted the item, show them the correct answer and any feedback, if the item supports it.";
$string["enablepushtab"] = "Enable Push Tab";
$string["enablepushtab_details"] =
    "The push tab allows someone with the Minilesson push capability (by default .. managers) to push settings from this activity to other activities on the site.";
$string["push"] = "Push";
$string["pushpage"] = "Push Page";
$string["pushpage_explanation"] =
    "Use the buttons on this page to push a setting from THIS MiniLesson instance to other MiniLesson activities. Be careful. There is no going back.";
$string["pushpage_clonecount"] =
    'Pushing settings from this activity will affect <b>{$a}</b> other activities.';
$string["pushpage_noclones"] =
    "There are no other activities in the affected scope. So there is nothing to push settings to.<br><br>";
$string["pushpage_done"] = 'Settings pushed to {$a} MiniLesson activities';
$string["pushpage_scopemodule"] =
    'MiniLesson activities (sitewide) with this activity name: <b>{$a}</b>';
$string["pushpage_scopecourse"] =
    'MiniLesson activities in this course: <b>{$a}</b>';
$string["pushpage_scopesite"] = "All MiniLesson activities in the site";
$string["pushpage_scopenone"] = "NO MiniLesson activities";
$string["pushpage_noactivities"] =
    "No MiniLesson activities match the criteria";
$string["pushpage_noitems"] =
    "There MiniLesson activities items in this activity";
$string["pushitems"] = "Lesson Items";
$string["pushitems_details"] =
    'The items in this MiniLesson will be pushed to matching MiniLessons. It will only push to MiniLessons in which every item\'s type, order and name match the items in this MiniLesson. It is intended to overwrite only existing items. It will overwrite text, images and audio in the items, but not the item type or order. It will not add new items to the target MiniLessons.';
$string["pushconfirm"] =
    'You are about to push the setting: <b>{$a->pushthing}</b> to {$a->clonecount} other activities. Are you sure?';
...
$string["nopasting_desc"] =
    "Disable copy/paste into the text area. This is to prevent students from pasting in answers from elsewhere.";
$string["attemptfor"] = 'Attempt: {$a}';
$string["alternatestreaming"] = "Enable alternate streaming";
$string["alternatestreaming_details"] =
    "Streams recorded audio for open transcription. Slightly slower then the default browser transcription and only works in English. On by default in mobile app on iOS.";
$string["cloudpoodllserver"] = "Cloud Poodll Server";
$string["cloudpoodllserver_details"] =
    "The server to use for Cloud Poodll. Only change this if Poodll has provided a different one.";
$string["customasrurl"] = "Custom ASR API URL";
$string["customasrurl_details"] =
    "The URL of a custom speech recognition API endpoint (e.g., a self-hosted Cree wav2vec2 model). Leave blank to use the default Poodll/Microsoft speech services.";
$string["customasrapikey"] = "Custom ASR API Key";
$string["customasrapikey_details"] =
    "An optional API key or bearer token for the custom ASR endpoint. Leave blank if no authentication is required.";
...
$string["hintrtl_desc"] =
    "If checked, the hint will be displayed in right-to-left format.";
$string["scatterdefrtl"] = "Definition RTL";
$string["scatterdefrtl_desc"] =
    "If checked, the definition will be displayed in right-to-left format.";
$string["gethints"] = "Get Hints";
$string["sentenceimage"] = "Sentence Images";
$string["sentenceimage_help"] =
    "(optional) Upload image files to be displayed with the sentence prompt. The image file name should match the sentence prompt number, eg. 1.png or 2.jpg";
$string["sentenceaudio"] = "Sentence Audios";
$string["sentenceaudio_help"] =
    "(optional) Upload audio files to match the sentence prompt. The audio file name should match the sentence prompt number, eg. 1.mp3 or 2.mp3";
$string["correctthreshold_desc"] =
    "The accuracy percentage required to pass the item.";
$string["correctthreshold"] = "Correct Threshold (%)";
$string["anotherhint"] = "Another hint";
$string["finish"] = "Finish";
$string["penalizehints"] = "Penalize for hints";
$string["penalizehints_desc"] =
    "If checked, the student will be penalized for using hints.";
$string["h5pforminstructions"] =
    "Select an H5P activity from the content bank and set the number of points this activity should contribute to the MiniLesson. Open the content bank (link below) and choose -add- to create an H5P activity if you need to.";
$string["aigen"] = "AI Generate";
$string["aigenpage"] = "AI Generate";
$string["aigenpage_done"] =
    'AI Generation Done: {$a} items created and added to the activity.';
$string["aigenpage_explanation"] =
    "Select a lesson template and then set the template options. The AI will use the current activity settings and the information you provide to generate the lesson items. The lesson items will be added to the current activity. In most cases the target language of the current MiniLesson will be used as the language for the generated items.";
$string["aigenpage_notemplates"] =
    "There are no AI Generate templates for your selected items (yet).";
$string["aigenconfirm"] =
    'You are about to use template: <b>{$a->title}</b> to generate {$a->templatecount} items. Are you sure?';
...
$string["sametemplatefound"] =
    "Template key used in template with name '{\$a->templatename}'";
$string["uploadtemplate"] = "Upload template";
$string["error:atleast2jsonfiles"] = "At least two json files needed";
$string["error:templatefilenotuploaded"] =
    "Template file with name name '*_template.json' not uploaded";
$string["error:templatefilejsonparsingfailed"] =
    "Template file with name '{\$a}' can not be readed";
$string["error:configfilenotuploaded"] =
    "Config file with name name '*_template.json' not uploaded";
$string["error:configfilejsonparsingfailed"] =
    "Config file with name '{\$a}' can not be readed";
$string["error:configfile:uniqueidmissing"] =
    "Template uniqueid not defined in config file";
$string["error:configfile:lessontitlemissing"] =
    "Template name not defined config file";
$string["error:configfile:lessondescriptionmissing"] =
    "Template description not defined in config file";
...
$string["aigentemplatename:reading_aic_passagegen"] =
    "Reading + AI Chat (Generated passage)";
$string["aigentemplatename:reading_aic_passageupload"] =
    "Reading + AI Chat (Uploaded passage) ";
$string["aigentemplatename:keywords_to_ws_sc"] =
    "Keywords to Word Shuffle and Scatter";
$string["aigentemplatename:keywords_to_ws_sc_sg"] =
    "Keywords to Word Shuffle and Scatter and Space Game";
$string["aigentemplatename:keywordstogapfillsfluency"] =
    "Keywords to GapFills / Fluency";
...
$string["aigentemplatename:fiction_withpics"] =
    "Interactive Fiction (with pictures)";
$string["aigentemplatename:fiction_nopics"] =
    "Interactive Fiction (no pictures)";
$string["aigentemplatename:narrativefiction_withpics"] =
    "Narrative Interactive Fiction (with pictures)";
$string["aigentemplatedescription:passagereading"] =
    "Enter a list of keywords and a topic, AI will prepare a passage of text and some reading and speaking activities based on it.";
$string["aigentemplatedescription:ayoutubelesson"] =
    "Enter a YouTube video id (or URL) and summaries. Poodll will generate a short lesson with multi-choice and speaking activities";
$string["aigentemplatedescription:youtubefinalelesson"] =
    "This is a lesson based on a YouTube video where the video is not shown until the very end.";
$string["aigentemplatedescription:wordpractice"] =
    "Enter a list of words (5) and Poodll will make a short activity for students to practice those words";
$string["aigentemplatedescription:wordpractice2"] =
    "Given a list of words, example sentences and the students native language, this template will generate a set of practice activities with images and native language hints. You can use up to 9 words.";
$string["aigentemplatedescription:audiostory"] =
    "Enter a topic, the learners language level and a type of story. AI will prepare an audio story with listening and speaking activities.";
$string["aigentemplatedescription:set_of_slides"] =
    "Enter a description of the tutorial that you would like AI to generate, and it will generate a set of slides with text and images for you to use.";
$string["aigentemplatedescription:set_of_slides_nopics"] =
    "Enter a description of the tutorial that you would like AI to generate, and it will generate a set of slides for you to use.";
$string["aigentemplatedescription:keywordstogapfillsfluency"] =
    "Enter a list of words (maximum 30) and Poodll will make a short activity for students to practice those words";
$string["aigentemplatedescription:reading_aic_passagegen"] =
    "This will take a topic and learner level and generate a reading passage that will be used in a passage reading and then an audio chat session";
$string["aigentemplatedescription:reading_aic_passageupload"] =
    "Paste in a reading passage, and 4 short answer questions. These will be used in a passage reading exercise and then an audio chat session";
$string["aigentemplatedescription:keywords_to_ws_sc"] =
    "Enter 4 - 10 keywords. The keywords will be used to generate a word shuffle and scatter activity. The keywords will also be used to generate a picture of each keyword on a blackboard.";
$string["aigentemplatedescription:keywords_to_ws_sc_sg"] =
    "Enter 4 - 10 keywords. The keywords will be used to generate a word shuffle and scatter activity, and a space game activity. The keywords will also be used to generate a picture of each keyword on a blackboard.";
$string["aigentemplatedescription:dialog_multichoice"] =
    "Students choose the picture that best represents the currently playing dialog. To create, enter 4 dialogs. They will form 4 multi-choice questions where the choice of answer is an image representing the currently playing dialog. The dialogs are in TTS Dialog format. e.g A) I like toast. [new line]  B) Me too.";
$string["aigentemplatedescription:image_slides"] =
    "Enter 5 image descriptions and an image style to get 5 image slides.";
...
$string["aigentemplatedescription:fiction_withpics"] =
    "Enter a detailed story outline to get an interactive fiction activity with pictures.";
$string["aigentemplatedescription:fiction_nopics"] =
    "Enter a detailed story outline to get a text-only interactive fiction activity (with a single poster image).";
$string["aigentemplatedescription:narrativefiction_withpics"] =
    "Enter a detailed story outline to get an interactive fiction activity  with fewer choices, more story, and pictures.";
$string["generationnotice"] =
    "<p>NB: After pressing save changes, please be patient. It may take a minute or two to complete</p>";
...
$string["mcanswerresponses"] =
    "Enter the answer options in the text area below. Each item should be a on a new line. Minimum of 2 options. Maximum of 4 options.";
$string["mcimageresponses"] =
    "(optional) Upload image files to be displayed with the answer option. The image file name should match the answer number, eg. 1.png or 2.jpg. Make sure to also choose to show images in the display options for this question.";
$string["mcaudioresponses"] =
    "(optional) Upload audio files to match the answer option. The audio file will be used instead of TTS audio. The audio file name should match the answer number, eg. 1.mp3 or 2.mp3.  Make sure to also choose to use audio in the display options for this question.";
$string["multiaudioaudioresponses"] =
    "(optional) Upload audio files to match the answer option. The audio file will be used instead of TTS audio. The audio file name should match the answer number, eg. 1.mp3 or 2.mp3.";
$string["audiochat_instructions"] = "Instructions for AI";
$string["audiochat_instructions_instructions"] =
    "The instructions are a template that combines with the AI role, AI voice, topic, AI custom data 1, AI custom data 2, student submission (on free writing or free speaking) and student native language to create the instructions passed to AI. You can use the following variables in the instructions: {ai role}, {ai voice}, {target language}, {native language}, {ai data1}, {ai data2}, {student submission} and {topic}. The default instructions are usually fine. But you can change them if you have a different use case.";
...
$string["gradebywordcount"] =
    "This activity was graded based on the number of words spoken in the transcript.";
...
$string["audiochat_autosend_desc"] =
    "If checked, turn-detection is automatic. The AI will automatically send the student audio when it detects that they have stopped speaking. For young or slower speakers that might be frustrating. If unchecked, audio is submitted when the microphone stop button is pressed. Auto send can also be toggled during the activity.";
$string["clicktosend"] = "click to send";
$string["cantchat"] =
    "Chat is NOT available. To use this item type you must have a valid OpenAI key set in the MiniLesson activity admin settings. Chat is also not available in China (Ningxia region)";

$string["confirm_desc"] =
    "You have not finished this step. Are you sure want to go to the next step?";

$string["ai_topic"] = "Topic";
$string["ai_data1"] = "AI Data1";
$string["ai_data2"] = "AI Data2";
$string["ai_topic_help"] =
    "Topic is an optional field {topic} that can be merged with the grading or feedback instructions to provide context for the AI.";
$string["ai_data1_help"] =
    "AI Data2 is an optional field {ai data1} that can be merged with the grading or feedback instructions to provide context for the AI.";
$string["ai_data2_help"] =
    "Topic is an optional field {ai data2} that can be merged with the grading or feedback instructions to provide context for the AI.";

$string["instructionprompt"] = "Instruction ";

$string["freewriting:gradingprompt1"] = "Default";
$string["freewriting:gradingprompt2"] =
    "Short Answer - requires the correct answer (ai data1)";
$string["freewriting:gradingprompt3"] =
    "Describe the picture - requires a picture description (ai data1)";
$string["freewriting:gradingprompt_dec1"] =
    "Deduct 1 point for each grammar, spelling or punctuation error.";
$string[
    "freewriting:gradingprompt_dec2"
] = 'The correct answer is "{ai data1}" Give 0 marks for an incorrect answer.
...
$string[
    "freewriting:gradingprompt_dec3"
] = 'The student is describing a picture. The picture depicts the following scene: [{topic}]
...
$string["freewriting:feedbackprompt_dec2"] =
    "Explain major grammar mistakes simply. Suggest any elements of the scene that the student did not describe.";

$string["freespeaking:gradingprompt1"] = "Default";
$string["freespeaking:gradingprompt2"] =
    "Short Answer - requires the correct answer (ai data1) ";
$string["freespeaking:gradingprompt3"] =
    "Describe the picture - requires a picture description (ai data1) ";
$string["freespeaking:gradingprompt_dec1"] =
    "Deduct 1 point for each grammar error.";
$string[
    "freespeaking:gradingprompt_dec2"
] = 'The correct answer is "{ai data1}" Give 0 marks for an incorrect answer.
...
$string[
    "freespeaking:gradingprompt_dec3"
] = 'The student is describing a picture. The picture depicts the following scene: [{topic}]
Give 2 points for each grammatically correct sentence that the student uses to describe part of the picture. Give 1 point if the sentence is almost correct.';
$string["freespeaking:feedbackprompt1"] = "Default";
$string["freespeaking:feedbackprompt2"] = "Describe the picture";
$string["freespeaking:feedbackprompt_dec1"] =
    "Explain each grammar mistake simply. Do not comment on spelling or punctuation.";
$string["freespeaking:feedbackprompt_dec2"] =
    "Explain non minor grammar mistakes simply. Do not comment on spelling or punctuation. Suggest any elements of the scene that the student did not describe.";
...
$string["audiochat:instructionsprompt2"] =
    "Discussing a picture - requires a picture description (topic) and questions (ai data1)";
$string["audiochat:instructionsprompt3"] =
    "Discussing a passage - requires a passage (topic) and questions (ai data1)";
$string["audiochat:instructionsprompt_dec1"] =
...
$string[
    "audiochat:instructionsprompt_dec2"
] = 'You are {ai role}. Your name is {ai voice}. You are teaching {target language}. The student is a native speaker of {native language}. The student is looking at a picture the depicts the following scene: "{topic}"
...
$string[
    "audiochat:instructionsprompt_dec3"
] = 'You are {ai role}. Your name is {ai voice}. You are teaching {target language}. The student is a native speaker of {native language}. The student has just read the following passage: "{topic}"
...
$string["audiochat:feedbackprompt2"] =
    "Discussion with questions - requires points and questions (ai data1)";
$string["audiochat:feedbackprompt_dec1"] =
    "For the score consider the following criteria: relevance to topic: '{topic}', fluency, and vocabulary usage. For feedback it should be simple, and in the student native language: {native language}.";
$string["audiochat:feedbackprompt_dec2"] =
    "Give 25 points for each correct answer to a question that was answered by the student. Give 0 points for incorrect answers. Give the student feedback on their use of language, and on their answers. Give feedback in the student native language: {native language}. These are the questions: {ai data1}";
...
$string["manageminilessonitems_explanation"] =
    'Here you can set the visibility of items in the "Add new item" dialog. Toggling hide and show here will not affect the items that have already been created.';
...
$string["mingrade_help"] =
    'The minimum grade required to "complete" this activity.';
$string["mingrade"] = "Minimum Grade";

$string["reorder"] = "Reorder";
$string["chooseitem"] = "Choose item";

$string["item_page_desc"] =
    "The Content Page is the most basic item. It simply shows the text or media content specified by the activity author and a next button. Use this content type to prepare students for subsequent items or to include educational content";
$string["item_multichoice_desc"] =
    "The Multi Choice item displays a multi choice question with up to 4 possible answers, only one of which is correct. Answer options can be text, audio or images";
$string["item_dictation_desc"] =
    "The Dictation item displays a list of audio player + text field sets. The student must listen to the audio and type what they hear";
$string["item_speechcards_desc"] =
    "The Speech Cards item displays a series of cards containing a phrase or a sentence. Students must read each card aloud.";
$string["item_listenrepeat_desc"] =
    "The Listen and Speak item presents a series of audio prompts to which the student must give an audio response. Mostly used for listen and repeat activities";
$string["item_multiaudio_desc"] =
    "The Multi Choice Audio item is a multi choice question where the student must answer by speaking the answer aloud.";
$string["item_shortanswer_desc"] =
    "The Short Answer item is a single question to which the student must give a spoken response. The correct responses are pre-determined by the item author.";
$string["item_listeninggapfill_desc"] =
    "The Listening Gapfill item displays a series of sentences with one or more words missing (gaps). The student must listen to the sentence and enter any missing words.";
$string["item_typinggapfill_desc"] =
    "The Typing Gapfill item displays a series of sentences with one or more words missing (gaps). The student must enter any missing words.";
$string["item_speakinggapfill_desc"] =
    "The Speaking Gapfill item displays a series of sentences with one or more words missing (gaps). The student must say aloud the completed sentence.";
$string["item_spacegame_desc"] =
    "The Space Game item is an arcade style game made from a list of word pairs. The student must “shoot” as many correct words as they can.";
$string["item_freespeaking_desc"] =
    "The Free Speaking item allows the teacher to set speaking tasks for the student that will be automatically graded and feedback given to student.";
$string["item_freewriting_desc"] =
    "The Free Writing item allows the teacher to set writing tasks for the student that will be automatically graded and feedback given to student.";
$string["item_passagereading_desc"] =
    "The passagereading item displays a multi choice question with up to 4 possible answers, only one of which is correct. Answer options can be text, audio or images";
$string["item_passagegapfill_desc"] =
    "The Passage Gapfill item gives the student a passage of text with multiple words removed. The student must listen to the accompanying audio and fill in the gaps.";
$string["item_h5p_desc"] =
    "The H5P item allows the author to select an existing H5P from the content bank and embed it within the Minilesson. H5P is a separate Moodle activity that is popular with language teachers.";
$string["item_wordshuffle_desc"] =
    "The Word Shuffle item takes a set of sentences The words in each sentence are re-arranged. The student must order the words correctly.";
$string["item_scatter_desc"] =
    "The Scatter item presents a grid of cards from a set of word pairs. Students must remove all the cards by matching each pair.";
$string["item_fluency_desc"] =
    "The Fluency item presents a series of sentences/phrases for students to say aloud. It marks up the parts of the spoken sentence that were good, ok or not good.";
$string["item_audiochat_desc"] =
    "The Audio Chat item sets up an audio conversation with an AI partner. It can be used for discussing a topic, or asking questions about a picture. The prompts to the AI bot are free text and editable.";
$string["item_smartframe_desc"] =
    "The SmartFrame item is a placeholder for an item type that has not been developed yet.";
$string["item_comprehensionquiz_desc"] =
    "The Comprehension Quiz item is a placeholder for an item type that has not been developed yet.";
$string["item_conversation_desc"] =
    "The Conversation item is a placeholder for an item type that has not been developed yet.";
$string["item_dictationchat_desc"] =
    "The Dictation Chat item presents a series of audio prompts to which the student must type a response. Mostly used for dictation activities.";
$string["item_slides_desc"] =
...
$string["item_fiction_desc"] =
    "The Fiction item allows the author to create a story with choices that the user can play. Fiction items are authored using a format called Yarn, so this is a feature for advanced users.";

$string["noitemyet"] =
    'There are no items in this MiniLesson. Press the \'Add new item\' button and choose an item type to get started.';
$string["addingcontent"] = "Click on ‘Add new item’ to start adding content";
$string["hidewarning"] = "Hide fair results";
$string["hidewarning_details"] =
    "Only show correct (green) and incorrect (red). ie Don't show almost correct (orange)";
...
$string["lessonbank:desc"] =
    'You can import ready made items from the lesson bank into your MiniLesson activity. Search using the form below and use the "import" button in the search item result to import the lesson items.';
...
$string["enterslidesmarkdown"] =
    'Enter Slides Markdown. Markdown is a sort of shorthand syntax for creating HTML. See the <a href="https://poodll.freshdesk.com/a/solutions/articles/19000169462" target="_blank">Slides Markdown Guide</a> for details.';
...
$string["shownonoptions_desc"] =
    'If \'yes\' options in the story that are not available (yet) to the user will be shown as disabled buttons. If \'no\' they will be hidden completely.';
$string["flowthroughmessages"] = "Flowthrough";
$string["flowthroughmessages_desc"] =
    'If \'yes\' sequential messages from the story will come through without the user pressing \'continue\', until it is the user\'s turn to choose an option.';
$string["enterfictionyarn"] =
    'Enter the story in Yarn format. Yarn format is a sort of shorthand syntax for creating interactive stories. See the <a href="https://docs.yarnspinner.dev/beginners-guide" target="_blank">Yarn Guide</a> for details. Also see the <a href="https://support.poodll.com/en/support/solutions/articles/19000171644-item-type-fiction" target="_blank">Poodll documentation.</a>';
$string["fictionyarn"] = "Fiction Yarn";
$string["templatetags"] = "Template tags";

$string["hideanswertext"] = "Hide Answer Text";
$string[
    "hideanswertext_detail"
] = 'When using images or audio as answers, check this option to hide the answer text from the
...
$string["correctfeedbackinstructions"] =
    "Feedback to be shown that explains the correct answer. (optional)";
...
$string["audiochat_student_submission_instructions"] =
    "If applicable set a Free Writing or Free Speaking item from earlier in the lesson. The transcript of the students submission can be passed into the AI prompt as context variable {student submission}. ";
$string["aicontextheading"] = "AI Context Data";
$string["aicontext_instructions"] =
    "The fields that follow are optional. They can be used to provide additional context (information in the prompt) to the AI when generating the lesson items. The fields can be referenced in the AI prompt using variables like: {ai data1}, {ai data2}.";
...
$string["aimanager_desc"] =
    "The AI Manager allows you to select which AI provider to use for various purposes in MiniLesson.";
$string["grade_student_submission"] = "Grade student submission";
$string["grade_student_submission_desc"] =
    "Requests to MiniLesson for AI to grade or correct student submissions will be directed to the AI provider selected here, or to Cloud Poodll AI services (the default).";
$string["cloudpoodll"] = "Cloud Poodll";
$string["choosenativelanguageinstructions"] =
    "Set your native language here. It may be used to provide feedback and help in the activity.";
$string["downloadtranslationmodel"] = "Download Translation Model";
$string["downloadtranslationmodel_desc"] =
    "This story uses translation features. Would you like to download the translation model? (This is a one-time download)";
...
$string["customkeys_help"] =
    'Add space separated list of keys for the virtual keyboard. E.g. "à â æ ç"';
$string["compact"] = "Compact";
$string["confirmactionmessage"] =
    "<p>Your previous attempt will be deleted. OK?</p>";
$string["attemptquestioncountmessage"] =
    'You have completed {$a->completed} out of {$a->totallessonitem} steps.';
...
$string["addlessonitem_desc"] =
    "Manually add lesson items to build your lesson";
$string["chooselessonitem_desc"] =
    "Choose a ready made lesson from the Lesson Bank";
$string["generatelessonitem_desc"] =
    "Generate a lesson or lesson items using AI";
