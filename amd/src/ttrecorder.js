define([
  ...
  "core/notification",
  "core/ajax",
  "mod_minilesson/ttaudiohelper",
  "mod_minilesson/ttbrowserrec",
  "core/str",
  "mod_minilesson/timer",
  "mod_minilesson/ttmsspeech",
  "mod_minilesson/mediauploader",
  "mod_minilesson/ttcreeasr",
], function (
  $,
  log,
  notification,
  ...
  return {
    ...
    init: function (opts) {
      ...
      if (this.using_customasr) {
        ...
        this.customasr_instance.init(
          this.customasrurl,
          this.customasrapikey,
          this.lang,
          customasrreferencetext,
        );
      }
      ...
      var on_stopped = function (blob) {
        ...
        if (that.savemedia) {
          ...
          message.mediaurl =
            that.uploader.config.s3root + that.uploader.config.s3filename;
    ...
    can_stream: function () {
      return (
        this.speechtoken &&
        this.speechtoken !== "false" &&
        (this.speechtokentype === "assemblyai" ||
          this.speechtokentype === "azure") &&
        !this.stt_guided
      );
    },
    ...
    update_currentprompt: function (newprompt) {
      this.currentPrompt = newprompt;
      if (this.msspeech_instance) {
    ...
    prepare_html: function () {
      ...
      this.speechtokenregion =
        this.controls.recorderbutton.data("speechtokenregion");
      this.speechtokenvalidseconds = this.controls.recorderbutton.data(
        "speechtokenvalidseconds",
      );
      this.speechtokentype =
        this.controls.recorderbutton.data("speechtokentype");
      ...
      this.savemediaregion =
        this.controls.recorderbutton.data("savemediaregion");
      ...
      this.customasrurl =
        this.controls.recorderbutton.data("customasrurl") || null;
      this.customasrapikey =
        this.controls.recorderbutton.data("customasrapikey") || "";
    },
    ...
    init_token_refresh: function () {
      ...
      if (that.speechtoken && validsecs > 0) {
        ...
        log.debug(
          "No valid streaming token available, skipping refresh setup.",
        );
      }
    },
